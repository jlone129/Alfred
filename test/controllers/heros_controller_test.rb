...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { attack: @hero.attack, health: @hero.health, name: @hero.name, spc_atk: @hero.spc_atk, special: @hero.special, status: @hero.status } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { attack: @hero.attack, health: @hero.health, name: @hero.name, spc_atk: @hero.spc_atk, special: @hero.special, status: @hero.status } }
